...
public class ListaDinamicaPrograIII {
  ...
  /**
    ...
    public static void main(String[] args) {
       ...
       lista.agregar_pastel("selva_negra"); //este agrege yo 
       
       
        lista.imprimirnodo(" ");   //imprimiendo pasteles de atras hacia delante
        
       lista.eliminar_pastel("3leches");// eliminacion del pastel de prueba
